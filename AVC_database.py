...
# Load YOLO model
model = YOLO("../AVC/Weights/best_tune2.pt")
...
def main():
    ...
    st.title("Automated Vehicles Classification (AVC) System")
    ...
    if uploaded_file is not None or use_webcam:
        ...
        while True:
            ...
            if current_vehicle:
                ...
                st.text(" ") #add space
                sql = "insert into VehiclesClassDetection(VehiclesClass, TollFare) values(%s, %s)"
